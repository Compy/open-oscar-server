...
// LocalPart returns the user portion of the screen name, stripping any @network suffix.
...
// local screen name with a network name (e.g., "user" + "retra.im" = "user@retra.im").
